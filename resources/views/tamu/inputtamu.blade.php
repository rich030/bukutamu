  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="{{ route('tamu.simpantamu') }}" method="POST">
            {{ csrf_field() }}
            <div class="form-group">
              <input type="varchar" id="nama" name="nama" class="form-control" placeholder="Nama">
            </div>
            <div class="form-group">
              <input type="varchar" id="email" name="email" class="form-control" placeholder="Email">
            </div>
            <div class="form-group">
